...
try {
    ...
    $checkout_session = $stripe->checkout->sessions->create([
        ...
        'mode' => 'payment',
        'success_url' => 'http://localhost:8000/view/front%20office/commande_success.php?session_id={CHECKOUT_SESSION_ID}',
        'cancel_url' => 'http://localhost:8000/view/front%20office/panier.php?error=cancelled',
        'locale' => 'fr',
    ]);
