...
<body>
  ...
  <div class="header">
    ...
    #reels-btn {
    position: fixed;
    bottom: 20px; /* éloigné du bas */
    right: 20px;  /* éloigné de la droite */
    z-index: 1000;
...
#reels-btn:hover {
    transform: scale(1.1);
        ...
        .video-wrapper {
            width: 100%;
            max-width: 375px; /* Largeur réduite comme Instagram Reels */
            height: calc(375px * 1.777); /* Ratio 9:16 */
            position: relative;
            margin: 0 auto;
        }
...
<button id="reels-btn">
  ...
  <div class="container">
    ...
    <div class="trending">
      <div class="activity-card"><img src="images/atelier.jpg" alt="Image 1">
        <h3>Ateliers</h3>
      </div>
      <div class="activity-card"><img src="images/bien.jpg" alt="Image 2">
        <h3>Bien-être</h3>
      </div>
      <div class="activity-card"><img src="images/air.jpg" alt="Image 3">
        <h3>Aérien</h3>
      </div>
      <div class="activity-card"><img src="images/cro.jpg" alt="Image 4">
        <h3>Croisières</h3>
      </div>
      <div class="activity-card"><img src="images/esq.jpg" alt="Image 5">
        <h3>Jeux & énigmes</h3>
      </div>
      <div class="activity-card"><img src="images/pilotage.jpg" alt="Image 5">
        <h3>Pilotage</h3>
      </div>
      <div class="activity-card"><img src="images/visit.jpg" alt="Image 5">
        <h3>Visites</h3>
      </div>
      <div class="activity-card"><img src="images/zone.jpg" alt="Image 5">
        <h3>Parcs de loisirs</h3>
      </div>
      <div class="activity-card"><img src="images/nature.jpg" alt="Image 5">
        <h3>Nature</h3>
      </div>
      <div class="activity-card"><img src="images/aqu.jpg" alt="Image 5">
        <h3>Aquatique</h3>
      </div>
      <div class="activity-card"><img src="images/sim.jpg" alt="Image 5">
        <h3>Simulateurs</h3>
      </div>
    </div>
    ...
    <div class="events">
      <div class="event-card"><img src="images/fes.jpg" alt="Événement 1">
        <h3>Festivals & Culture</h3>
      </div>
      <div class="event-card"><img src="images/mus.jpg" alt="Événement 2">
        <h3>Concerts & Musique</h3>
      </div>
      <div class="event-card"><img src="images/fam.jpg" alt="Événement 3">
        <h3>Famille & Enfants (Kids Friendly)</h3>
      </div>
      <div class="event-card"><img src="images/groupe.jpg" alt="Événement 4">
        <h3>Récompenses ou Challenges</h3>
      </div>
      <div class="event-card"><img src="images/hallo.jpg" alt="Événement 4">
        <h3>Saisonniers ou Thématiques</h3>
      </div>
      <div class="event-card"><img src="images/fete.jpg" alt="Événement 4">
        <h3>Privés / Fêtes</h3>
      </div>
    </div>
