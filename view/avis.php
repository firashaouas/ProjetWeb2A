...
$demandeController = new DemandeCovoiturageController($pdo);

$id_passager = isset($_GET['id_passager']) ? (int)$_GET['id_passager'] : 0;
$demande = $demandeController->getDemandeById($id_passager);

if (!$demande || $demande['status_demande'] !== 'approuvée') {
    die("Demande non trouvée ou non approuvée.");
}
...
if (isset($_POST['submit'])) {
    try {
        ...
        $message = $avisController->createAvis($id_passager, $note, $commentaire);
...
<head>
    ...
    <title>Laissez votre avis - Click'N'go</title>
...
<body>
    <div class="container">
        ...
        <p style="text-align: center; margin-bottom: 20px;">
            Demande de <?php echo htmlspecialchars($demande['prenom_passager'] . ' ' . $demande['nom_passager']); ?>
            (Conducteur ID: <?php echo htmlspecialchars($demande['id_conducteur']); ?>)
        </p>
        <form method="post" action="">
            ...
            <button type="submit" name="submit">Soumettre l'avis</button>
        </form>
