...
<head>
<meta charset="UTF-8">
<title>Modifier une demande de covoiturage</title>
    ...
    <div class="form-wrapper">
      ...
      <form method="POST" action="">
        ...
        <div class="mb-4">
          ...
          <input type="text" id="tel_passager" name="tel_passager" 
        ...
        <div class="mb-4">
          ...
          <input type="number" id="nbr_places_reservees" name="nbr_places_reservees" 
                 ...
                 min="1" max="<?php echo htmlspecialchars($annonceDetails ? $annonceDetails->getNombrePlaces() : 8); ?>" 
        ...
        <div class="mb-4">
          ...
          <textarea id="message" name="message" rows="4" 
                    placeholder="Message pour le conducteur"><?php echo htmlspecialchars($demandeDetails['message'] ?? ''); ?></textarea>
        </div>

        <button type="submit" name="submit" class="elsa-gradient-primary hover:elsa-gradient-primary-hover">
          <i class="fas fa-save"></i> Enregistrer les modifications
        </button>
        
        <a href="ListPassager.php" class="block text-center mt-4 text-[#be3cf0] hover:text-[#ff50aa]">
