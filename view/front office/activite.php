...
<head>
  ...
  <style>
    ...
    .description-section {
      padding: 20px 0;
      background: linear-gradient(135deg, #f8e1f4, #e6d5f5); /* Dégradé rose bébé vers lilas */
      margin-bottom: 25px;
      border-radius: 10px;
    ...
    .description-container {
      max-width: 750px; /* Rétrécir encore plus la largeur */
      margin: 0 auto;
      padding: 0 8px;
    }
    ...
    .description-container h2:after {
      ...
      width: 300px;
      height: 2px;
      background-color: #D48DD8; /* Rose lilas */
    }
    ...
    .description-intro {
      ...
      margin-bottom: 10px;
      font-weight: 500;
      color: #7B506F; /* Violet rosé */
    }
    
    .description-highlight {
      font-weight: 600;
      color: #B565A7; /* Rose violacé */
      margin-top: 12px;
      font-size: 0.9rem;
      line-height: 1.4;
      padding: 6px;
    ...
    .description-stats {
      ...
      justify-content: center;
      width: 100%;
      max-width: 240px; /* Rétrécir encore plus les stats */
    }
    
    .stat-item {
      background: linear-gradient(135deg, #D48DD8, #9768D1); /* Dégradé rose lilas vers violet */
      color: white;
      padding: 10px 5px;
      border-radius: 7px;
    ...
    .categories-section {
      padding: 40px 30px;
      background: linear-gradient(135deg, #e6d5f5, #f8e1f4); /* Dégradé lilas vers rose bébé (inversé) */
      border-radius: 15px;
    ...
    .personalization-panel {
      position: fixed;
      top: 180px; /* Position légèrement plus haute */
      right: -320px;
      width: 320px;
      background: rgba(245, 240, 255, 0.97); /* Fond plus clair avec teinte lilas très légère */
      border-radius: 12px 0 0 12px;
      border-left: 3px solid #D48DD8; /* Bordure lilas sur le côté gauche */
      box-shadow: -5px 0 20px rgba(151, 104, 209, 0.2);
      z-index: 9998; /* Réduire le z-index pour être sous le bouton */
      transition: right 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275);
      overflow: hidden;
    }
    ...
    .new-feature-notification {
      display: none; /* Masquer complètement la notification */
    }
    ...
    #toggle-personalization {
      width: 90px;
      height: 90px;
      background: linear-gradient(135deg, #D48DD8, #9768D1); /* Lilas pastel au lieu de rose vif */
    ...
    .personalization-content {
      ...
      max-height: 80vh;
      overflow-y: auto;
      background: linear-gradient(to bottom, rgba(245, 240, 255, 0.5), rgba(255, 250, 255, 0.8)); /* Dégradé très léger */
    }
    ...
    body.dark-theme {
      background-color: #2D2340; /* Fond violet foncé */
      color: #f0f0f0;
    }
    
    body.dark-theme .header {
      background-color: #2A1F3D; /* Violet très foncé */
    ...
    body.dark-theme .avis-content {
      background-color: #3A2E52 !important; /* Fond violet moyen */
    ...
    body.dark-theme .category-content .exclusives .description-container {
      background-color: #483D61 !important; /* Violet doux */
      border-color: #544870 !important;
    }
    
    body.dark-theme .category-content .exclusives p.description {
      color: #e0d1f0 !important; /* Texte lavande clair */
    }
    ...
    body.dark-theme .personalization-panel {
      background: rgba(45, 35, 64, 0.97); /* Fond violet foncé avec transparence */
      border-left: 3px solid #D48DD8; /* Bordure lilas */
      box-shadow: -5px 0 20px rgba(151, 104, 209, 0.3);
    }
    
    body.dark-theme .personalization-content {
      background: linear-gradient(to bottom, rgba(58, 46, 82, 0.8), rgba(45, 35, 64, 0.9)); /* Dégradé violet */
    }
    
    body.dark-theme .personalization-section {
      background-color: rgba(58, 46, 82, 0.8); /* Fond violet moyen */
    ...
    @keyframes pulse-float {
      0% {
        box-shadow: 0 0 0 0 rgba(212, 141, 216, 0.7); /* Lilas pastel */
        transform: scale(1);
      }
      50% {
        box-shadow: 0 0 25px 10px rgba(212, 141, 216, 0.5); /* Lilas pastel */
        transform: scale(1.05);
      }
      100% {
        box-shadow: 0 0 0 0 rgba(212, 141, 216, 0); /* Lilas pastel */
        transform: scale(1);
      }
    }
...
<body>
    ...
    <header class="header header-activite" style="background-image: url('images/banner act.jpg'); background-size: cover; background-position: center; padding-top: 10px;">
        <nav style="margin-top: -90px;">
            ...
            <ul class="nav-links">
                ...
                <li class="dropdown">
                    <a href="activite.php" class="dropbtn">Activités</a>
            ...
            ?>
                <div>
                    ...
                    <span>
                        ...
                        <a href="reservation.php?id=<?php echo urlencode($activity['id']); ?>" class="register-btn">Réserver</a>
                    </span>
                </div>
            <?php
                endforeach;
          ...
          grid.innerHTML += `
            <div class="activite-card">
              ...
              <div class="activite-content">
                ...
                <a href="reservation.php?id=${activity.id}" class="register-btn">Réserver</a>
              </div>
            </div>
          `;
        });
  ...
  <script>
    $(document).ready(function () {
      ...
      $(".floating-customize-btn, #toggle-personalization").click(function() {
        $(".personalization-panel").toggleClass("open");
