...
<body>
  ...
  <section class="categorie-block" id="projets-sur-mesure">
    ...
    <!-- Nouvelle section personnalisée moderne -->
    <section class="custom-solution-section">
      <div class="bubble left"></div>
      <div class="bubble right"></div>
      <div class="content">
        <h3>Besoin d'une solution personnalisée&nbsp;?</h3>
        <p>Notre équipe d'experts est à votre disposition pour étudier votre demande et vous proposer une solution adaptée à vos objectifs et contraintes spécifiques. Profitez d'un accompagnement sur-mesure, créatif et réactif, pour faire de votre projet un succès unique.</p>
        <a href="#">Contactez notre équipe dédiée</a>
      </div>
    </section>
      ...
      <div class="testimonials-slider">
        ...
        <div class="testimonial-card">
            <div class="testimonial-content">
              <p>"L'équipe de Click&Go a organisé notre séminaire annuel avec professionnalisme. Tout était parfait, de l'hébergement aux activités team building. Nos collaborateurs sont revenus motivés et soudés."</p>
          </div>
          <div class="testimonial-author">
              <div class="author-image">
            <img src="images/sarah.jpg" alt="Sarah L.">
              </div>
            <div class="author-info">
              <h4>Sarah L.</h4>
              <p>Directrice RH, Société Tech</p>
            </div>
          </div>
        </div>
        ...
        <div class="testimonial-card">
            <div class="testimonial-content">
              <p>"Notre challenge paintball a été un véritable succès ! Organisation impeccable, encadrement de qualité et un excellent rapport qualité-prix. Je recommande vivement !"</p>
          </div>
          <div class="testimonial-author">
              <div class="author-image">
            <img src="images/mohamed.jpg" alt="Mohamed R.">
              </div>
            <div class="author-info">
              <h4>Mohamed R.</h4>
              <p>Manager, Entreprise Financière</p>
            </div>
          </div>
        </div>
        ...
        <div class="testimonial-card">
            <div class="testimonial-content">
              <p>"La soirée de gala organisée pour les 20 ans de notre entreprise restera gravée dans les mémoires. Un grand merci à toute l'équipe pour cette prestation exceptionnelle."</p>
          </div>
          <div class="testimonial-author">
              <div class="author-image">
            <img src="images/leila.jpg" alt="Leila B.">
              </div>
            <div class="author-info">
              <h4>Leila B.</h4>
              <p>PDG, Groupe Industriel</p>
            </div>
          </div>
          </div>
        </div>
      ...
      <div class="faq-accordion">
        <div class="faq-item">
          <div class="faq-question">
            ...
            <h3>Comment réserver une activité pour mon entreprise ?</h3>
          </div>
          <div class="faq-answer">
            <p>Pour réserver une activité, vous pouvez cliquer sur le bouton "Réserver" de l'activité qui vous intéresse, nous contacter directement par téléphone au +216 XX XXX XXX ou remplir notre formulaire de demande de devis en ligne. Notre équipe vous recontactera dans les 24 heures ouvrées.</p>
          </div>
        </div>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <span class="faq-icon"></span>
            <h3>Quels sont les délais de réservation ?</h3>
          </div>
          <div class="faq-answer">
            <p>Nous recommandons de réserver au moins 2 semaines à l'avance pour les activités standards et 1 mois pour les événements d'envergure ou sur mesure. Des réservations de dernière minute peuvent parfois être accommodées selon les disponibilités.</p>
          </div>
        </div>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <span class="faq-icon"></span>
            <h3>Proposez-vous des formules personnalisées ?</h3>
          </div>
          <div class="faq-answer">
            <p>Absolument ! Nous sommes spécialisés dans la création d'expériences sur mesure adaptées à vos objectifs, votre culture d'entreprise et votre budget. Contactez-nous pour discuter de votre projet et nous vous proposerons une solution parfaitement adaptée.</p>
          </div>
        </div>
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer">
            <p>Nous demandons généralement un acompte de 30% à la réservation et le solde 7 jours avant l'événement. Pour les projets importants, un échéancier de paiement peut être mis en place. Nous acceptons les virements bancaires et les paiements par carte.</p>
          </div>
        </div>
      </div>
    </div>
...
<style>
  /* Styles pour la section FAQ révisée */
  .faq-section {
    padding: 70px 0;
  ...
  .faq-section:before {
    ...
    width: 100%;
    height: 100%;
    background-image: radial-gradient(circle at 10% 20%, rgba(166, 4, 171, 0.03) 0%, transparent 20%),
                      radial-gradient(circle at 90% 80%, rgba(166, 4, 171, 0.03) 0%, transparent 20%);
    z-index: 0;
  }
  ...
  .faq-title-decoration {
    height: 2px;
    width: 70px;
    background: linear-gradient(90deg, transparent, #a604ab, transparent);
    margin: 0 20px;
  }
...
<script>
  // Script pour la navigation des témoignages sur mobile
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.innerWidth < 992) {
      ...
      const cardWidth = cards[0].offsetWidth + 15; // largeur + margin
      ...
      // Mettre à jour le dot actif lors du scroll
