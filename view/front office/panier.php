...
<head>
    ...
    <style>
        ...
        * {
        ...
        .best-sellers-section, .gestion-features, .reviews-section { display: none; }
        ...
        .cart-item-details { flex-grow: 1; padding: 0 20px; }
        .cart-item-price { font-weight: bold; color: #ff4d4d; }
        .quantity-controls { display: flex; align-items: center; gap: 10px; }
        .quantity-btn { background: #f0f0f0; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; }
...
<body>
    ...
    <script>
        ...
        function redirigerVersAcheter() {
            ...
            window.location.href = `acheter.html?quantite=${totalQuantite}&prix_total=${totalFinal.toFixed(2)}`;
        }
